...
class SelectCountryDataScreen extends ConsumerStatefulWidget {
  const SelectCountryDataScreen({super.key});

  @override
  ConsumerState<SelectCountryDataScreen> createState() => _SelectCountryDataScreenState();
}

class _SelectCountryDataScreenState extends ConsumerState<SelectCountryDataScreen> {
  ...
  void _autoSelectUserCountry(List<Country> countries) {
    ...
    if (selectedCountry != null) {
      ref.read(dataWizardProvider.notifier).selectCountry(selectedCountry);
  ...
  void _selectCountry(Country country) {
    ref.read(dataWizardProvider.notifier).selectCountry(country);
    context.push('/data/enter-phone');
  }
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Choose the country for your data bundle.',
          ...
          child: _filteredCountries.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final selectedCountryCode = ref.watch(dataWizardProvider).selectedCountry?.code;
                    return _CountryCard(
                      country: country,
