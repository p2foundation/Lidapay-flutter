...
class _EmailVerificationScreenState extends ConsumerState<EmailVerificationScreen> {
  ...
  Future<void> _sendVerificationCode() async {
    ...
    try {
      ...
      final response = await rewardsRepository.requestEmailVerification(_email!);
  ...
  Future<void> _verifyCode() async {
    ...
    try {
      final rewardsRepository = RewardsRepository(ref.read(apiClientProvider));
      final response = await rewardsRepository.confirmEmailVerification(_email!, _codeController.text);
      
      if (response.success) {
        // Award points for successful verification
        await rewardsRepository.awardVerificationPoints('email');
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Email verified! You earned ${response.pointsAwarded ?? 50} points!'),
            backgroundColor: AppColors.lightSuccess,
          ),
        );
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Verify your email address to earn 50 reward points and unlock all features.',
